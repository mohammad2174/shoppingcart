    ...
    render() {
      ...
      const watches = products.slice(8, 12)
        const product = {
          ...
          inventory: this.state.watch.inventory,
          id: this.state.watch.id,
          count: this.state.watch.count,
          rating: this.state.watch.rating,
          reviewCount: this.state.watch.reviewCount,
          href: '#',
      ...
      return (
        ...
        <div className="flex gap-2 text-base font-extrabold tracking-tight text-gray-900 sm:gap-5">
          ...
          <Link to="/watches" className="text-gray-400">Watches</Link>
          </div>
                    ...
                    <section aria-labelledby="options-heading" className="mt-10">
                      <h3 id="options-heading" className="sr-only">
                        ...
                        <button
                          ...
                          onClick={() => addToCard(this.state.watch.id, this.state.selectedColor, this.state.selectedSize) && this.setClose() || this.setNotifyOpen() || this.setTimeout()}             
                        >
                          Add to bag
                        </button>
