...
class Sweaters extends Component {
  ...
  setOpen = (sweater) => {
    this.setState({open : true, sweater : sweater})
  }
    ...
    render() {
      ...
      return (
        ...
        <div className="flex gap-2 text-base font-extrabold tracking-tight text-gray-900 sm:gap-5">
          ...
          <Link to="/sweaters" className="text-gray-400">Sweaters</Link>
          </div>
                    ...
                    <section aria-labelledby="options-heading" className="mt-10">
                      <h3 id="options-heading" className="sr-only">
                        ...
                        <button
                          ...
                          onClick={() => addToCard(this.state.sweater.id, this.state.selectedColor, this.state.selectedSize) && this.setClose() || this.setNotifyOpen() || this.setTimeout()}             
                        >
                          Add to bag
                        </button>
