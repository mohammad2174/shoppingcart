      ...
      return (
        ...
        <Navigation product={products} />
          <div className="mt-16 w-full text-center">
            <p className="font-black text-5xl">My Way</p>
            <p className="mt-8 text-gray-700">Solid walnut base with rare earth magnets and polycarbonate add-ons.</p>
          </div>
...
export default connect(mapStateToProps, null)(MyWay);