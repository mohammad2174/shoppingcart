...
class ReArranged extends Component {
      ...
      return (
        ...
        <Navigation product={products} />
          <div className="mt-16 w-full text-center">
            <p className="font-black text-5xl">Re-Arranged</p>
            <p className="mt-8 text-gray-700">Designed by My Way, Includes Small Tray, Large Tray, Pen Tray ,Inc.</p>
          </div>
          <div className="m-16 grid grid-cols-1 gap-y-10 gap-x-1 sm:grid-cols-2 lg:grid-cols-4">
            {products.map((product) => (
              <>
              {product.name === 'Re-Arranged' ?  
...
export default connect(mapStateToProps, null)(ReArranged);