    ...
    render() {
      ...
      return (
        ...
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <Link to="/woman-tops" className="text-gray-400">Tops</Link>
          </div>
                    ...
                    <section aria-labelledby="options-heading" className="mt-10">
                      <h3 id="options-heading" className="sr-only">
                        ...
                        <button
                          ...
                          onClick={() => addToCard(this.state.top.id, this.state.selectedColor, this.state.selectedSize) && this.setClose()}             
                        >
                          Add to bag
                        </button>
